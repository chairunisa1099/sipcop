...
<head>
  ...
  <title>Pencatatan Covid 19 | Log in Petugas</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Login</b>Petugas</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Silahkan Login</p>

    <?php echo form_open('authen'); ?>
      <div class="form-group has-feedback">
        <input type="username" value="petugas" name='username' id='username' class="form-control" placeholder="Email">
