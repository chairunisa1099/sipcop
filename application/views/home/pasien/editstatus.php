<div class="row">
  <div class="col-md-12">
    <div class="box box-info">
      ...
      <?php echo form_open('pasien/editstatus/'.$pasien['nik']); ?>
      <div class="box-body">
        <div class="row clearfix">
          ...
          <input type="hidden" name="old_status" value="<?php echo ($this->input->post('old_status') ? $this->input->post('old_status') : $statussekarang); ?>" class="form-control" id="old_status" />
          <div class="col-md-12">
            <label for="catatan" class="control-label">Catatan</label>
            <div class="form-group">
              <input type="text" name="catatan" value="<?php echo ($this->input->post('catatan') ? $this->input->post('catatan') : ''); ?>" class="form-control" id="catatan" />
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <input disabled type="date" name="tgl_lhr" value="<?php echo date('Y-m-d\TH:i:s', strtotime($pasien['tgl_lhr'])); ?>" class="form-control" id="tgl_lhr" />
            </div>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <input disabled type="datetime-local" name="tgl_kwn" value="<?php echo date('Y-m-d\TH:i:s', strtotime($pasien['tgl_kwn'])); ?>" class="form-control" id="tgl_kwn" />
            </div>
          </div>
          <div class="col-md-6">
