<div class="row">
  <div class="col-md-12">
    <div class="box box-info">
      ...
      <?php echo form_open('pasien/edit/'.$pasien['nik']); ?>
      <div class="box-body">
        <div class="row clearfix">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="number" name="nik" value="<?php echo ($this->input->post('nik') ? $this->input->post('nik') : $pasien['nik']); ?>" class="form-control" id="nik" />
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="text" name="nama_lgkp" value="<?php echo ($this->input->post('nama_lgkp') ? $this->input->post('nama_lgkp') : $pasien['nama_lgkp']); ?>" class="form-control" id="nama_lgkp" />
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              <input type="text" name="tmpt_lhr" value="<?php echo ($this->input->post('tmpt_lhr') ? $this->input->post('tmpt_lhr') : $pasien['tmpt_lhr']); ?>" class="form-control" id="tmpt_lhr" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="tgl_lhr" class="control-label">Tanggal Lahir</label>
            <div class="form-group">
              <input type="date" name="tgl_lhr" value="<?php echo date('Y-m-d', strtotime($pasien['tgl_lhr'])); ?>" class="form-control" id="tgl_lhr" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="gol_darah" class="control-label">Gol Darah</label>
            <div class="form-group">
              <input type="text" name="gol_darah" value="<?php echo ($this->input->post('gol_darah') ? $this->input->post('gol_darah') : $pasien['gol_darah']); ?>" class="form-control" id="gol_darah" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="agama" class="control-label">Agama</label>
            <div class="form-group">
              <input type="text" name="agama" value="<?php echo ($this->input->post('agama') ? $this->input->post('agama') : $pasien['agama']); ?>" class="form-control" id="agama" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="no_akta_lhr" class="control-label">No Akta Lhr</label>
            <div class="form-group">
              <input type="text" name="no_akta_lhr" value="<?php echo ($this->input->post('no_akta_lhr') ? $this->input->post('no_akta_lhr') : $pasien['no_akta_lhr']); ?>" class="form-control" id="no_akta_lhr" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="status_kawin" class="control-label">Status Kawin</label>
            <div class="form-group">
              <input type="text" name="status_kawin" value="<?php echo ($this->input->post('status_kawin') ? $this->input->post('status_kawin') : $pasien['status_kawin']); ?>" class="form-control" id="status_kawin" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="no_akta_kwn" class="control-label">No Akta Kawin</label>
            <div class="form-group">
              <input type="text" name="no_akta_kwn" value="<?php echo ($this->input->post('no_akta_kwn') ? $this->input->post('no_akta_kwn') : $pasien['no_akta_kwn']); ?>" class="form-control" id="no_akta_kwn" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="tgl_kwn" class="control-label">Tanggal Kawin</label>
            <div class="form-group">
              <input type="date" name="tgl_kwn" value="<?php echo date('Y-m-d', strtotime($pasien['tgl_kwn'])); ?>" class="form-control" id="tgl_kwn" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="pendidikan" class="control-label">Pendidikan</label>
            <div class="form-group">
              <input type="text" name="pendidikan" value="<?php echo ($this->input->post('pendidikan') ? $this->input->post('pendidikan') : $pasien['pendidikan']); ?>" class="form-control" id="pendidikan" />
            </div>
          </div>
          <div class="col-md-6">
            <label for="pekerjaan" class="control-label">Pekerjaan</label>
            <div class="form-group">
              <input type="text" name="pekerjaan" value="<?php echo ($this->input->post('pekerjaan') ? $this->input->post('pekerjaan') : $pasien['pekerjaan']); ?>" class="form-control" id="pekerjaan" />
            </div>
          </div>
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="number" name="no_kk" value="<?php echo ($this->input->post('no_kk') ? $this->input->post('no_kk') : $pasien['no_kk']); ?>" class="form-control" id="no_kk" />
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="text" name="hub_kel" value="<?php echo ($this->input->post('hub_kel') ? $this->input->post('hub_kel') : $pasien['hub_kel']); ?>" class="form-control" id="hub_kel" />
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="text" name="nama_lgkp_ibu" value="<?php echo ($this->input->post('nama_lgkp_ibu') ? $this->input->post('nama_lgkp_ibu') : $pasien['nama_lgkp_ibu']); ?>" class="form-control" id="nama_lgkp_ibu" />
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="text" name="nama_lgkp_ayah" value="<?php echo ($this->input->post('nama_lgkp_ayah') ? $this->input->post('nama_lgkp_ayah') : $pasien['nama_lgkp_ayah']); ?>" class="form-control" id="nama_lgkp_ayah" />
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="text" name="no_rt" value="<?php echo ($this->input->post('no_rt') ? $this->input->post('no_rt') : $pasien['no_rt']); ?>" class="form-control" id="no_rt" />
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="text" name="no_rw" value="<?php echo ($this->input->post('no_rw') ? $this->input->post('no_rw') : $pasien['no_rw']); ?>" class="form-control" id="no_rw" />
          ...
          <div class="col-md-12">
            ...
            <div class="form-group">
              <input type="text" name="nama_kel" value="<?php echo ($this->input->post('nama_kel') ? $this->input->post('nama_kel') : $pasien['nama_kel']); ?>" class="form-control" id="nama_kel" />
