            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs"><?php echo $this->session->userdata(SESSIONDATA_LOGIN_PETUGAS_USERNAME);?></span>
                    </a>
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                <?php echo $this->session->userdata(SESSIONDATA_LOGIN_PETUGAS_USERNAME);?>
                                <br>
                                <small><?php echo $this->session->userdata(SESSIONDATA_LOGIN_PETUGAS_NAMA);?></small>
                                <br>
                                <small><?php echo $this->session->userdata(SESSIONDATA_LOGIN_PETUGAS_DESKRIPSI);?></small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
                        <li class="user-footer">
                            <div class="pull-right">
                                <a href="<?php echo site_url('authen/logout') ?>" class="btn btn-default btn-flat">Keluar</a>
                            </div>
                        </li>
                    </ul>
                </li>
